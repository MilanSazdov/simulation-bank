...
enum PolozajDrustva{NEZAPOSLEN, ZAPOSLEN, U_PENZIJI};
enum DozvolaBankeZaPrekoracenja{DOZVOLJENO, NEDOZVOLJENO};
enum OgranicenjaPodizanjaGotovine{OGRANICENO, NEOGRANICENO};
...
class TekuciRacun : public LicnaKarta{
    ...
    protected:
        ...
        PolozajDrustva stanje;
        float CenaOtvaranjaRacuna;
        float CenaZatvaranjaRacuna;
        DozvolaBankeZaPrekoracenja prekoracenje;
        float KamataZaPrekoracenje;
        OgranicenjaPodizanjaGotovine ogranicenja;
        float MaxZaPodizanje;

    public:
        
        TekuciRacun() : LicnaKarta(){
            stanje = ZAPOSLEN;
            CenaOtvaranjaRacuna = 5000.86;
            CenaZatvaranjaRacuna = 1450.93;
            prekoracenje = NEDOZVOLJENO;
            KamataZaPrekoracenje = 0.03; // 3% - nikad nece doci do kamate 
            ogranicenja = OGRANICENO;
            MaxZaPodizanje = 25000.50;
        }
...
class DevizniRacun : public  LicnaKarta{};
